...
namespace Microsoft.Storage
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorageBlobDeletedEventData :  IEquatable<StorageBlobDeletedEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageBlobDeletedEventData" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StorageBlobDeletedEventData {\n");
        ...
        {
            return this.Equals(input as StorageBlobDeletedEventData);
        }

        /// <summary>
        /// Returns true if StorageBlobDeletedEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of StorageBlobDeletedEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageBlobDeletedEventData input)
        {
            if (input == null)
                return false;
