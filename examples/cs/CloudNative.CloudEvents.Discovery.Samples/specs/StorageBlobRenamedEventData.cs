...
namespace Microsoft.Storage
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorageBlobRenamedEventData :  IEquatable<StorageBlobRenamedEventData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageBlobRenamedEventData" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The path to the blob that was renamed.</value>
        ...
        /// </summary>
        /// <value>The new path to the blob after the rename operation.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StorageBlobRenamedEventData {\n");
        ...
        {
            return this.Equals(input as StorageBlobRenamedEventData);
        }

        /// <summary>
        /// Returns true if StorageBlobRenamedEventData instances are equal
        /// </summary>
        /// <param name="input">Instance of StorageBlobRenamedEventData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageBlobRenamedEventData input)
        {
            if (input == null)
                return false;
